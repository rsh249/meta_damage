#goals 
#this is an attempt into constructing functions to later be implemented into the pico package outline output

# checkpoints:
# 1) convert script into function (later with examples)
# 2) apply into pico
...
ref = 'mito_reference.fna' #change to chloroplast or bacterial?
...
system('gunzip mito_reference.fna.gz')
